...
export default function TodoCreatePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900" data-testid="todo-create-page">
      <header className="sticky top-0 z-50 bg-white dark:bg-neutral-800 shadow-sm h-[60px] flex items-center px-4 md:px-6">
        <div className="w-full max-w-[1200px] mx-auto flex items-center gap-3">
          ...
          <span className="text-base font-semibold text-neutral-900 dark:text-white">새 할일</span>
        </div>
      </header>
        ...
        <div className="w-full max-w-[720px] mx-auto">
          <form onSubmit={handleSubmit} noValidate>
            <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm p-6 flex flex-col gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1" htmlFor="due-date">종료예정일</label>
                <input
                  id="due-date"
                  type="date"
                  value={dueDate}
